...
public class foodUtilities {
    public static void createFoods(){
        ItemStack vanillaIceCream = itemUtilities.potionHeadItem(ChatColor.WHITE + "Ice Cream " + ChatColor.GRAY  + "(Vanilla)",
        ...
        ItemStack melonIceCream = itemUtilities.potionHeadItem(ChatColor.WHITE + "Ice Cream " + ChatColor.GRAY  + "(Melon)",
        ...
        ItemStack chocolate = itemUtilities.foodHeadItem(ChatColor.WHITE + "Chocolate", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvODE5Zjk0OGQxNzcxOGFkYWNlNWRkNmUwNTBjNTg2MjI5NjUzZmVmNjQ1ZDcxMTNhYjk0ZDE3YjYzOWNjNDY2In19fQ==", "2", "1");
